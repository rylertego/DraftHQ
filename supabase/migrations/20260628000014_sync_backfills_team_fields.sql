-- Replace sync_sleeper_league_history to also backfill last_season_record
-- and last_season_playoffs on league_teams after standings are written.
...
begin
  ...
  loop
    ...
    -- Backfill denormalized fields on the franchise card

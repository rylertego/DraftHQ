...
const requiredFunctions = [
  ...
  "resume_draft(uuid)",
  "respond_to_league_invitation(uuid, text)",
  "start_draft(uuid)",
  "sync_sleeper_league_history(uuid, text, integer, text, jsonb, uuid)",
  "undo_pick(uuid)",
...
const expectedServiceRoleGrants = {
  ...
  leagues: [],
  league_members: [],
  league_invitations: ["INSERT", "SELECT", "UPDATE"],
  league_seasons: ["SELECT"],
  league_season_standings: [],
  league_team_seasons: ["SELECT"],
  league_teams: ["SELECT"],
  picks: [],
  players: [],
  profiles: [],
